...
```javascript
MILLISECONDS_IN_HOUR = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-milliseconds-in-hour@v0.1.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-milliseconds-in-hour@v0.1.0-umd/browser.js"></script>
```
